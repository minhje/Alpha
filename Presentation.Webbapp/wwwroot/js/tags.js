function initTagSelector(config) {
    ...
    const selectedInputIds = document.getElementById(config.hiddenInputId); // Ensure this matches the hidden input ID
    ...
    function updateSelectedIdsInput() {
        if (selectedInputIds) {
            selectedInputIds.value = selectedIds.join(','); // Update the hidden input with a comma-separated list of IDs
        }
    }
